            ...
            <div key={index} className='py-4 border-t border-b text-gray-500 flex flex-col md:flex-row md:items-center justify-between gap-4'>
              <div className='flex items-start gap-6 text-sm'>
                ...
                <div>
                  ...
                  <p className='mt-2'>Date: <span className='text-gray-300'>25, July,2024</span></p>
                </div>
              </div>
              ...
              <button className='bg-red-500 border px-4 py-2 text-sm font-medium text-white rounded-sm'>Track Order</button>
            </div>
            </div>
          )
        })}
